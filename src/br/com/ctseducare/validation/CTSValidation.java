...
public class CTSValidation {
    ...
    private static final String PATTERN_EMAIL = "^[-\\da-zA-Z.+_]+@[-\\da-zA-Z.+_]+\\.[a-zA-Z]{2,4}$";
    ...
    public static boolean cpfIsValid(String cpf) {
        ...
        return digito == Integer.parseInt(String.valueOf(cpf.charAt(10)));
    }
    ...
    public static boolean cnpjIsValid(String cnpj) {
        ...
        return digito == Integer.parseInt(String.valueOf(cnpj.charAt(13)));
    }
